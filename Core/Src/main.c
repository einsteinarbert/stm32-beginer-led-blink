...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, Led_blink_Pin|Led_blinkB2_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : Led_blink_Pin Led_blinkB2_Pin */
  GPIO_InitStruct.Pin = Led_blink_Pin|Led_blinkB2_Pin;
